...
async function post_to_vozforum(params) {
    let browser = null
    try {
        ...
        await page.goto(`https://vozforum.org/forums/quang-cao-ads.258/post-thread`)
        ...
        await page.click('div.formSubmitRow-controls > button')
        await page.waitForTimeout(1000)
        await page.click('div.formSubmitRow-controls > button')
        ...
        await page.waitForSelector('ul.message-attribution-main.listInline > li > a > time')
        ...
        return {
            code: 200,
            message: 'Đăng bài viết lên site Voz forum thành công',
            data
        }
    } catch (err) {
        if (browser) {
